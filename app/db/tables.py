...
class NameServices(Base):
    ...
    id_name_services = Column(Integer, primary_key=True, index=True)
    name = Column(String(250), unique=True)
...
class Services(Base):
    ...
    id_verifier = Column(Integer, ForeignKey('user.id_user', ondelete="CASCADE"), default=null)
    id_name_services = Column(Integer, ForeignKey('nameservices.id_name_services', ondelete="CASCADE"))
...
class UserServices(Base):
    ...
    id_services = Column(Integer, ForeignKey('services.id_services', ondelete="CASCADE"), primary_key = True)
...
class Category(Base):
    ...
    id_promotion = Column(Integer, ForeignKey('promotion.id_promotion', ondelete="CASCADE"), default=null)
    name = Column(String(250))
...
class Product(Base):
    ...
    id_category = Column(Integer, ForeignKey('category.id_category', ondelete="CASCADE"))
    id_gender = Column(Integer, ForeignKey('gender.id_gender', ondelete="CASCADE"))
...
class BillDetails(Base):
    ...
    id_product = Column(Integer, ForeignKey('product.id_product', ondelete="CASCADE"))
...
class ProductDetail(Base):
    ...
    id_product = Column(Integer, ForeignKey('product.id_product', ondelete="CASCADE"))
    id_color = Column(Integer, ForeignKey('color.id_color', ondelete="CASCADE"))
    id_image = Column(Integer, ForeignKey('image.id_image', ondelete="CASCADE"))
    ...
    image = relationship("Image", back_populates="product_detail")
...
class RateProduct(Base):
    ...
    id_comments = Column(Integer, ForeignKey('comments.id_comments', ondelete="CASCADE"))
