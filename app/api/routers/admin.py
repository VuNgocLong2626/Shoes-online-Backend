...
async def create_admin(
    admin_create: _admin_schemas.UserCreate,
    admin_in: dict = Depends(get_current_admin)
):
...
async def update_admin(
    admin_info: _info_schemas.InfoUpdate,
    admin_in: dict = Depends(get_current_admin)
):
...
@router.get("/")
async def get_admin_token(admin_in: dict = Depends(get_current_admin)):
