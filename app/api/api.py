...
from app.api.routers import statistics, permission, name_services, user, admin, gender, promotion, color, size, category, product, file, bill, rate, rate_comment, services, payment
