...
from app.db.repositories.category.get_firts_by_name_category \
    import get_by_name_category
from app.db.repositories.category.create_name_caregory \
    import create_name_category
...
from app.db.repositories.product_detail.create_produc_detail \
    import create_product_detail
from app.db.repositories.size_quantity.create_quantity \
    import create_size_quatity
